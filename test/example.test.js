...
test('It should take in a cephalopod object and return an li element', (expect) => {
    ...
    const expected = `<li class="cephalopod">
                <h2>Becky</h2>
                <h3>Cuttlefish</h3>
                <img src="../assets/francis-nie-DcitvRh5n18-unsplash.jpg" alt="cuttlefish"></img>
                <p class="description">Becky is a cuttlefish (or cuttles for short). Cuttlefish range between 6 - 10 inches in length and live about 2 years. Their diet consists mainly of crabs, shrimp, and fish. They're considered one of the most intelligent invertebrates on earth!</p>
